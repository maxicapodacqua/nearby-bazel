...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_maxicapodacqua_nearby",
        importpath = "github.com/maxicapodacqua/nearby",
        sum = "h1:6DasFWNy4aMWA+RJOJKgyJBi3i5FlF7qP0PguN+2jqo=",
        version = "v0.0.0-20230412010317-bdab91dcfa47",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GyDFqNnESLOhwwDRaHGdp2jKLDzpyT/rNLglX3ZkMSU=",
        version = "v1.21.1",
    )
    go_repository(
